...
export default function ProductCard({
  ...
  return (
    <Card className="w-full max-w-xs rounded-xl shadow-md bg-white dark:bg-gray-800 hover:shadow-lg transition-shadow  border-[0.1px] hover:border-gray-800 dark:hover:border-gray-700">
